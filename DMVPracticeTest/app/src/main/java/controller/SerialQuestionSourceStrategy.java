 ...
 */
public class SerialQuestionSourceStrategy implements QuestionSourceStrategy {
    ...
    public void requestNextQuestion(QuestionCallBack qcb, Context context) {
        ...
        Log.d("DMV", "Getting question number - " + questionNumber);
        qcb.hereIsTheQuestion(allQuestions.get(questionNumber));
    }
